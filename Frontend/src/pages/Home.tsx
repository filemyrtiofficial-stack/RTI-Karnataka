...
export const Home: React.FC = () => {
  ...
  const pageDescription = `File RTI online in Karnataka with FileMyRTI. Get expert-drafted RTI applications and appeals for Karnataka Government departments and district offices from home.`;
